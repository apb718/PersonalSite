...
<nav class="bg-apb-b flex items-center justify-between px-32 py-4 ">
	...
	<ul class="flex space-x-6">
		...
		<li><a href="#About" class="text-apb-y text-lg font-semibold hover:underline">About</a></li>
		<li><a href="#Interests" class="text-apb-y text-lg font-semibold hover:underline">Interests</a></li>
